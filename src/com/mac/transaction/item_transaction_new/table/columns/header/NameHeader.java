 ...
 * @author mohan
 */
public class NameHeader extends HeaderPanel implements TableCellRenderer {
    ...
    private void initComponents() {
        ...
        cDLabel1.setText("NAME");

        txtName.setValueEditable(false);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtName, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    protected void initUI(TTransactionDetail transactionDetail) {
        if (transactionDetail != null ? transactionDetail.getMItem() != null : false) {
            txtName.setCValue(transactionDetail.getMItem().getName());
        } else {
            txtName.setCValue("");
        }
    }

 ...
 * @author mohan
 */
public class NetValueHeader extends HeaderPanel implements TableCellRenderer {

    /**
     * Creates new form BatchHeader
     */
    public NetValueHeader() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtNetValue, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    protected void initUI(TTransactionDetail transactionDetail) {
        if (transactionDetail != null ? transactionDetail.getNetValue() != null : false) {
            txtNetValue.setCValue(transactionDetail.getNetValue());
        } else {
            txtNetValue.setCValue(0.0);
        }
    }

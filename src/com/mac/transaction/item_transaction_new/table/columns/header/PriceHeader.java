 ...
 * @author mohan
 */
public class PriceHeader extends HeaderPanel implements TableCellRenderer {
    ...
    private void initComponents() {
        ...
        lblBatchNo.setText("PRICE");

        txtPrice.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtPrice.setValueEditable(false);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(txtPrice, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    protected void initUI(TTransactionDetail transactionDetail) {
        if (transactionDetail != null ? transactionDetail.getPrice() != null : false) {
            txtPrice.setCValue(transactionDetail.getPrice());
        } else {
            txtPrice.setCValue(0.0);
        }
    }

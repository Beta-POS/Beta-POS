 ...
 * @author mohan
 */
public class QuantityHeader extends HeaderPanel implements TableCellRenderer {
    ...
    protected void initUI(TTransactionDetail transactionDetail) {
        if (transactionDetail != null ? transactionDetail.getQuantity() != null : false) {
            txtQuantity.setCValue(transactionDetail.getQuantity());
        } else {
            txtQuantity.setCValue(0);
        }
    }

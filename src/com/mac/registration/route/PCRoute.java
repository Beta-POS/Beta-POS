...
import com.mac.registration.route.object.MRoute;
 ...
 * @author user
 */
public class PCRoute extends HashObjectCreator<MRoute> {
    ...
    @Override
    protected Class<? extends MRoute> getObjectClass() {
        return com.mac.registration.route.object.MRoute.class;
    }

    @Override
    protected void afterInitObject(MRoute object) throws ObjectCreatorException {
...
//        set max text lengh
    ...
    public void setNewMood() {
        super.setNewMood();
        int number = SystemSettingInterface.getSystemSetting(SystemSettingInterface.ROUTE_AUTO_CODE).valueAsInteger();
        String prefix = "";
        if (number != 0) {
            try {
                String code = AutoCodeUtil.getCode(prefix, number, "m_route", "branch='" + HashUtil.getBranch() + "'");

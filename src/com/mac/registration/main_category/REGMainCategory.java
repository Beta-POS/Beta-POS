 ...
 * @author thilanga
 */
public class REGMainCategory extends AbstractRegistrationForm {

    @Override
    public AbstractObjectCreator getObjectCreator() {
        return new PCMainCategory();
    }
    ...
    protected List getTableData() throws DatabaseException {
        Criteria criteria = getDatabaseService().initCriteria(MMainCategory.class);

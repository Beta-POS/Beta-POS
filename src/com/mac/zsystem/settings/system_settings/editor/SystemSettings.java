...
public class SystemSettings extends AbstractGridObject {
    ...
    protected Collection getTableData() {
        try {
//            return CPanel.GLOBAL.getDatabaseService().getCollection("FROM com.mac.zsystem.settings.system_settings.editor.RSystemSetting ");
            return getDatabaseService().getCollection(RSystemSetting.class);
//            return SystemSettingInterface.SYSTEM_SETTINGS;

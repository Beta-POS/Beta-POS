 ...
 * @author mohan
 */
public class PCUserRolePermission extends DefaultObjectCreator<RUserRole> {

    /**
     * Creates new form PCUserRolePermission
     */
    public PCUserRolePermission() {
        initComponents();
    ...
    private void initOthers() {
        tblPermission.setObjectCreator(new PCPermission() {
            @Override
            protected CPanel getCPanel() {
                return PCUserRolePermission.this.getCPanel();
            }
        });
    ...
    protected List<CInputComponentBinder> getInputComponentBinders() {
        return Arrays.asList(
                ...
                new CInputComponentBinder(tblPermission, "RPermissions"));
    }

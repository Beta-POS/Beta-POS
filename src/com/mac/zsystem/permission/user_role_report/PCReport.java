...
import com.mac.zsystem.permission.object.MReport;
 ...
 * @author mohan
 */
public class PCReport extends AbstractObjectCreator<MReport> {

    /**
     * Creates new form PCReport
     */
    public PCReport() {
        initComponents();
    ...
    private List getPermission() {
        try {
            return getCPanel().getDatabaseService().getCollection(MReport.class);
    ...
    @Override
    protected void setValueAbstract(MReport value) throws ObjectCreatorException {
    }

    @Override
    protected MReport getValueAbstract() throws ObjectCreatorException {
        return (MReport) cboPermission.getCValue();
    }
